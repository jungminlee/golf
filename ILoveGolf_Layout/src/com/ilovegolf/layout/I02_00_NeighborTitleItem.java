...
public class I02_00_NeighborTitleItem {
	LinearLayout i02_00_neighbortitleitem=null;
	public View i02_00_btn_myarea=null;
	public View i02_00_btn_otherarea=null;
	public View getLayout(Context context, Display display) {
		...
		i02_00_neighbortitleitem = new LinearLayout(context);
		{
			...
			linear.setBackgroundResource(R.drawable.main_near_list_bar);
			i02_00_neighbortitleitem.addView(linear);
			{
...
//				icon.setBackgroundResource(R.drawable.titlebar_ico_near);
				linear.addView(icon);
...
//				title.setText("나와 가까이에 있는 골퍼");
				...
				linear.addView(linear2);
				{
					...
					i02_00_btn_myarea=new View(context);
					LinearLayout.LayoutParams param3=new LinearLayout.LayoutParams(tempWidth, tempHeight);
					param3.setMargins(0, 0, paddingWidth, 0);
					i02_00_btn_myarea.setLayoutParams(param3);
					i02_00_btn_myarea.setBackgroundResource(R.drawable.btn_my_area);
					linear2.addView(i02_00_btn_myarea);
					
					i02_00_btn_otherarea=new View(context);
					i02_00_btn_otherarea.setLayoutParams(new LayoutParams(tempWidth, tempHeight));
					i02_00_btn_otherarea.setBackgroundResource(R.drawable.btn_other_area);
					linear2.addView(i02_00_btn_otherarea);
					
				}
			}
		}
		
		return i02_00_neighbortitleitem;
