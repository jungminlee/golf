...
public class I03_00_FavoriteTitleItem {
	LinearLayout i03_00_favoritetitleitem=null;
	public View getLayout(Context context, Display display) {
		...
		i03_00_favoritetitleitem = new LinearLayout(context);
		{
			...
			i03_00_favoritetitleitem.addView(linear);
//			{
...
//			}
		...
		return i03_00_favoritetitleitem;
