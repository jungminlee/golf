...
public class IabHelper {
	...
	public void startSetup(final OnIabSetupFinishedListener listener) {
		...
		System.out.println("어디까지 되나 확인111111111111111");
		// Connection to IAB service
		logDebug("Starting in-app billing setup.");
		mServiceConn = new ServiceConnection() {
			@Override
			public void onServiceDisconnected(ComponentName name) {
				System.out.println("어디까지 되나 확인222222222222222");
			...
			public void onServiceConnected(ComponentName name, IBinder service) {
				...
				System.out.println("어디까지 되나 확인3333333333333333");
				logDebug("Billing service connected.");
				mService = IInAppBillingService.Stub.asInterface(service);
				String packageName = mContext.getPackageName();
				System.out.println("???????????????????????////////setupstart" + mSetupDone);
				try {
					...
					System.out.println("???????????????????????////////setupdone" + mSetupDone);
		...
		System.out.println("어디까지 되나 확인444444444444444444");
		Intent serviceIntent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
		if (!mContext.getPackageManager().queryIntentServices(serviceIntent, 0).isEmpty()) {
			System.out.println("어디까지 되나 확인555555555555555555");
			...
			System.out.println("어디까지 되나 확인6666666666666");
			if (listener != null) {
	...
	/**
	 * Handles an activity result that's part of the purchase flow in in-app billing. If you are calling {@link #launchPurchaseFlow}, then you must call this method from your Activity's {@link android.app.Activity@onActivityResult} method. This method MUST be called from the UI thread of the Activity.
	 * 
	 * @param requestCode
